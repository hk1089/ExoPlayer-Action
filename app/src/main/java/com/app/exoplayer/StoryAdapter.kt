...
import com.app.exoplayer.databinding.ItemUserStoryBinding
import com.lib.exo.statusView.data.entity.HkUserStoryModel

class StoryAdapter (
    private var listOfUseStory: ArrayList<HkUserStoryModel>,
    ...
    fun setUserStoryData(mDataList: ArrayList<HkUserStoryModel>) {
