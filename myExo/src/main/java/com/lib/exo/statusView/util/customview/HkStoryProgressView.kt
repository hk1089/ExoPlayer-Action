...
class HkStoryProgressView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyle: Int = 0
) : LinearLayout(context, attrs, defStyle) {

    private val progressViewMis: MutableList<HkProgressView> = ArrayList()
    ...
    private fun createProgressBar(): HkProgressView {
        return HkProgressView(context).apply {
            layoutParams =
    ...
    private fun callback(index: Int): HkProgressView.Callback {
        return object : HkProgressView.Callback {
    ...
    fun getProgressWithIndex(index: Int): HkProgressView {
